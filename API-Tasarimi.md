...
**OpenAPI Spesifikasyon Dosyası:** [flend.yaml](flend.yaml)

Bu doküman, OpenAPI Specification (OAS) 3.0 standardına göre hazırlanmış Flend B2B SaaS projesinin API tasarımını içermektedir.
